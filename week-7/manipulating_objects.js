...
//What tests did you have trouble passing? What did you do to make it pass? Why did that work? - I had to look up the exact syntax for object literal assignment. then I had issues getting through step 8 where you add the carson property to terahs children. I first just didn't totally understand what the instructions wanted me to do, but after a couple read thrus I understood. Once I knew that, then I was trying to do it without curly braces, finally I wrote it out and it worked
// How difficult was it to add and delete properties outside of the object itself? - super easy
// What did you learn about manipulating objects in this challenge? - I got a solid understanding of how to do some simple added and deleting objects with straightforward commands. I'm excited to see how these skills will roll over into the next challenges.
